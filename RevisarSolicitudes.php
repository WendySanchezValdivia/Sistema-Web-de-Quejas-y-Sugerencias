...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <h1>Revisar Solicitudes</h1>
    <form action="RevisarSolicitudes.php" method="post">
    ...
    <table>
        ...
        <tr>
            ...
            <td><a href="verDetalles.php?id=<?php echo $row['id']; ?>">Ver Detalles</a></td>
            <td><a href="eliminarQuejaa.php?id=<?php echo $row['id']; ?>" onclick="return confirm('¿Está seguro de que desea eliminar esta queja?');">Eliminar</a></td>
        </tr>
        <?php endwhile; ?>
    </table>
